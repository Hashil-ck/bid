...
function Jobs() {
    ...
    return (
        <div>
            ...
            <div className='md:w-[630px] w-[380px] lg:w-full md:ml-0 ml-3 h-auto bg-white mt-7 pl-4 py-3 rounded'>
                <div className='flex justify-between'>
                    <div>
                        ...
                        <div className='flex md:justify-between mt-6'>
                            ...
                            <div className='md:w-[150px] h-auto bg-white rounded-xl border flex p-1 md:ml-0 ml-3 '>
                                <div className='w-[80px] bg-blue-600 h-[100%] rounded-xl text-sm  flex items-center justify-center text-white'>Metric</div>
                                <div className='w-[50px] h-auto flex rounded-xl text-sm items-center justify-center '>Us</div>

                            </div>
                        </div>
                        <div className='flex justify-between mt-6'>
                            <p className='brightness-200 text-xs md:text-base'>Difficulty Level</p>
            ...
            <div className='pt-6 md:flex md:ml-0 ml-16'>
                <div className='relative'>
                    ...
                    <input type="text"  className='rounded-lg pl-8 w-[250px] h-[30px]' placeholder='Search Projects' name="" id="" />
            ...
            <div className='md:w-[630px] lg:w-full md:h-auto h-auto bg-white mt-7 md:pl-3 pl-5 md:p-0 p-4 rounded'>
                <table className='w-100' style={{ width: '100%' }}>
                    ...
                    <tbody className='border-b '>
                                ...
                                <tr className='mt-6'>
                                    <td className='md:text-sm text-xs pt-3'>1</td>
                                    <td className='md:text-sm text-xs'>Assembly names</td>
                                    <td className='text-blue-600 md:text-sm text-xs '>100 M</td>
                                    <td className='text-blue-600 md:text-sm text-xs flex justify-between mt-2'>120
                                        <div className='flex'>
                                            <i  class="cursor-pointer hover:brightness-150 fa-solid fa-trash md:-ml-5 ml-3 absolute"></i>
                                        </div>
                                    </td>
                                </tr>
